...
plt.stackplot(df.index, 
              ...
              labels=[f"{s.capitalize()} Output" for s in sources if s in positive_data],
...
plt.savefig('output/power_distribution.png', dpi=300, bbox_inches='tight')
...
plt.legend(loc='upper left', fontsize=10)
plt.grid(True, alpha=0.3)
plt.savefig('output/typical_week_power.png', dpi=300, bbox_inches='tight')
...
plt.axis('equal')
plt.savefig('output/power_contribution_pie.png', dpi=300, bbox_inches='tight')
...
plt.title('Power Dispatch Priority and Average Output', fontsize=16)
plt.xlabel('Average Power Output (kW)', fontsize=12)
plt.grid(True, alpha=0.3, axis='x')
plt.savefig('output/power_dispatch_priority.png', dpi=300, bbox_inches='tight')
...
plt.grid(True, alpha=0.3)
plt.legend(loc='upper left', fontsize=10)
plt.savefig('output/daily_power_profile.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('output/weekly_comparison.png', dpi=300, bbox_inches='tight')
